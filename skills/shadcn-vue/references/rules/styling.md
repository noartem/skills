...
See `references/theming.md` for theming, CSS variables, and adding custom colors.
...
If you need a success/positive color that doesn't exist as a semantic token, use a Badge variant or ask the user about adding a custom CSS variable to the theme (see `references/theming.md`).
...
3. **CSS variables** — define custom colors in the global CSS file (see `references/theming.md`).
